    ...
    return (
        <section className={styles["ui-page"]}>
            ...
            <div className={styles["display"]}>
                ...
                <div className={styles["container"]}>
                    <Card title="Mate" desc="Ideal para unos mates bien amargos." imgUrl="https://estiloaustral.com/wp-content/uploads/2023/03/0002s_0008_MATE0049-MATE-IMPERIAL-DOBLE-VIROLA-1.png.webp" price={100}/>
